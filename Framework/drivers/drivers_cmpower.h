...
#define    CM_current_lower      16000.f
#define 	 CMFLIntensity_lower   4200.f
#define    CMFRIntensity_lower   4200.f
#define  	 CMBLIntensity_lower   4200.f
#define	   CMBRIntensity_lower   4200.f

#define    CM_current_MAX      21000.f
#define    CMFLIntensity_MAX   5600.f
#define    CMFRIntensity_MAX   5600.f
#define    CMBLIntensity_MAX   5600.f
#define    CMBRIntensity_MAX   5600.f
